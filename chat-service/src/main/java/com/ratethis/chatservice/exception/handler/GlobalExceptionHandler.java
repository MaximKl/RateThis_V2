package com.ratethis.chatservice.exception.handler;

import com.ratethis.chatservice.exception.ExceptionObject;
import com.ratethis.chatservice.exception.IdentificationException;
import com.ratethis.chatservice.exception.ProductOrUserNotFoundException;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(value = ProductOrUserNotFoundException.class)
    protected ResponseEntity<Object> handleProfileOrProductNotFound(ProductOrUserNotFoundException ex, WebRequest request) {
